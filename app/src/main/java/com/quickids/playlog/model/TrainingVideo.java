...
public class TrainingVideo implements Video, Serializable {
    Bitmap thumbnail;
    ...
    public TrainingVideo(Bitmap thumbnail, String path, String name, String date, String runningTime, String extn, long size) {
